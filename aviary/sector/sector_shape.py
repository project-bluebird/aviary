...
class GeneratedShape(SectorShape):
    ...
    def __init__(self, sector_type, length_nm = LENGTH_NM,
...
#
#     def __i_fix_points__(self, polygon):
...
#         self._routes = self.create_routes()
#
#     def __x_polygon__(self):
#         return cascaded_union([self.i_shape(), rotate(self.i_shape(), 90)])
#
#     def x_fix_points(self):
#
#         polygon = self.__polygon__()
#         x_mid, y_mid = polygon.centroid.coords[0]
#         x_min, y_min, x_max, y_max = polygon.bounds
