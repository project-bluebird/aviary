...
def test_separation_metric():
    ...
    assert pairwise_separation_metric(lon1, lat1, alt1, lon2, lat2, alt2) == -0.8

    lon2, lat2, alt2 = (0.15, 0, 0)

    assert pairwise_separation_metric(lon1, lat1, alt1, lon2, lat2, alt2) == -0.2
    ...
    assert pairwise_separation_metric(lon1, lat1, alt1, lon2, lat2, alt2) == -0.77

    lon2, lat2, alt2 = (0, 0, 1500/_SCALE_METRES_TO_FEET)

    assert pairwise_separation_metric(lon1, lat1, alt1, lon2, lat2, alt2) == -0.5
